<template>
  <Watermark content="vue3-admin-antdv" :zIndex="99999">
        ...
        <div class="main-container">
          <div class="sub-container">
            <RouterView v-slot="{Component}">
              <KeepAlive :include="cacheTabs.tabsList">
  ...
  <Modal v-model:open="modifyPasswordModalVisible" :title="modifyPasswordModalTitle" :closable="true" :keyboard="false" :maskClosable="false" :footer="null" :destroyOnClose="true" @cancel="onCancel">
...
import {Button, Dropdown, Form, Input, Layout, Menu, message, Modal, Space, Tabs, Watermark} from 'ant-design-vue'
...
const cacheTabs = reactive({tabsList: [] as string[]})
...
watch(currentRoute, () => {
  updateBreadCrumb()
  cacheTabs.tabsList = TabsStore().tabList.map(e => String(e.name))
})
